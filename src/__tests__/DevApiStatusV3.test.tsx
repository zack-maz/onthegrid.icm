...
// Phase 29 Plan 08 D-02 part D — Topbar pipeline-version pill describe
// block removed. The pill component was deleted in Plan 08 Task 2 because
// its only function was querying the now-deleted POST
// /api/events/llm-pipeline endpoint (Plan 04). Per RESEARCH Question 5 +
// A4, no static-v3 replacement pill was kept, so no replacement test is
// needed.
