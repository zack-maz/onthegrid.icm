...
_Last updated: 2026-06-10 after Phase 43 (Ghost Link Prune Correctness) completion. Six target features locked in operator priority order (water filter / ghost links + events subtab / dashboard subtab cleanup / ~100-user load test / general hardening / docs cleanup). v1.6 archives at `.planning/milestones/v1.6-*`._
