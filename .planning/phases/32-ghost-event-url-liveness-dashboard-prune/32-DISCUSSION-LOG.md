...
| Option                                                                                                                                                                                                                                  | Description                                                  | Selected |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | -------- |
| Lock all defaults (key shape per-event, schema {status,lastProbedAt,attemptCount,lastUrlProbed,lastHttpStatus}, TTL 7d/24h/1h by status tier, User-Agent identifies app, contract test in src/**tests**/lib/urlLiveness.schema.test.ts) | Bundle confirm.                                              | ✓        |
