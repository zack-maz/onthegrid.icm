...
- Logged for a future maintenance phase to either (a) extend `check:env` to whitelist VITE\__ + retired LLM_PIPELINE_V[23], or (b) delete the stale `.env.example` blocks. Phase 35 (REDIS-OPT / SIMPLIFY-_ cleanup) is a candidate.
