...
- 🚧 **v1.5 LLM Reliability & Reveal Prep** -- Phases 29-37 (started 2026-05-09); 43 requirements across 8 phases (Vercel Pro upgrade locked in Phase 29; SIMPLIFY-\* track retires Hobby-era workarounds); acceptance gate = 3 consecutive prod-connectivity-audit.yml exit-0 runs (unblocks 999.5 load test for v1.6)
